        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-2xl'>$74,378.58</p>
            </div>
          </div>
          <div className='mt-6'>
            <Button
        ...
        rounded-2xl md:w-780'>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className='border-r-1 border-color m-4 pr-10'>
              ...
              <div>
                <p>
                  <span className='text-3xl font-semibold'>$1,36,000</span>
                  <span className='p-1.5 hover:drop-shadow-xl
                  cursor-pointer rounded-full text-white bg-green-400 ml-3 text-xs'>45%</span>
                </p>
              ...
              <div className='mt-8'>
                <p>
                  <span className='text-3xl font-semibold'>$59,000</span>
                </p>
